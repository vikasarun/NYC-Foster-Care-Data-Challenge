...
# set working directory (this should be changed based on structure of local machine)
setwd("~/Documents/Columbia/NYC Foster Care Data Challenge/")

# create afcars.foster data frame
afcars.foster <- read.csv("./Clean Data/ny_afcars.csv", stringsAsFactors = FALSE)

...
# prediction_data <- data.frame(c_preteen, c_female, c_disabled, child_behavior_prob, child_neglect, c_moving_high,
...
#                               f_payment_high, family_same_race, outcome_discharge_reason) #f_same_race, outcome_discharge_reason)
...
# output the group size matrix
size_matrix

# get list of Ci's and Fj's
ci_fj <- list()
#ci_fj[1] <- sum(subset(prob_matrix, c_preteen == 0, c_disabled == 0, )$group_size)
